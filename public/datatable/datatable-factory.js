...
import { VueDatatableCell } from './datatable/vue-datatable-cell/vue-datatable-cell';
import { VueDatatableHeader } from './datatable/vue-datatable-header/vue-datatable-header';
...
export class DatatableFactory implements PluginObject < void > {
     ...
     * @returns `this` for chaining.
     */
        public registerTableType < TRow extends {} = {},
    TSource = TRow[],
    TFiltered = TRow[],
    TSorted = TRow[],
    TPaged = TRow[] > (
        ...
        const tableType = nameOrTableType instanceof TableType ? nameOrTableType : new TableType < TRow,
            TSource, TFiltered, TSorted, TPaged > (nameOrTableType);

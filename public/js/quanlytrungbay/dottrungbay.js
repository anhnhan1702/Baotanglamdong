var vm = new Vue({
    ...
    methods: {
        ...
        saveform() {
            this.tieude = 'Thêm mới đợt trưng bày'
        ...
        submitform() {
            ...
            if (this.statusForm == "insert") {
                ...
                axios.post("/save-dot-trung-bay", formData, {
                    headers: {
                ...
                axios.post("/update-dot-trung-bay", {
                    id: self.rowId,
        ...
        doAlertDelete(data, row, tr, target) {
            ...
            this.$confirm('Thao tác này không thể quay lại, bạn chắc chắn tiếp tục?', 'Cảnh báo', {
                ...
                axios.delete("/delete-dot-trung-bay?id=" + data.id)
                    .then(function (response) {
                        self.loadData();
                    })

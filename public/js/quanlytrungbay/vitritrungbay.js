var vm = new Vue({
    ...
    methods: {
        ...
        saveform() {
            this.tieude = 'Thêm mới vị trí trưng bày'
        ...
        submitform() {
            ...
            if (this.statusForm == "insert") {
                ...
                axios.post("/save-vi-tri-trung-bay", formData, {
                    headers: {
                ...
                axios.post("/update-vi-tri-trung-bay", {
                    id: self.rowId,
        ...
        doAlertEdit(data) {
            ...
            this.tieude = 'Sửa vị trí trưng bày'
        ...
        doAlertDelete(data, row, tr, target) {
            ...
            this.$confirm('Thao tác này không thể quay lại, bạn chắc chắn tiếp tục?', 'Cảnh báo', {
                ...
                axios.delete("/delete-vi-tri-trung-bay?id=" + data.id)
                    .then(function (response) {
                        self.loadData();
                    })

    ...
    methods: {
        ...
        doAlertDelete(data, row, tr, target) {
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.isConfirmed) {
                    const self = this;
                    axios.delete("/delete-he-so-luong?id=" + data.id)
        ...
        submitform() {
            ...
            if (this.statusForm == "insert") {
                axios.post("/save-he-so-luong", self.dataForm.data).then(function(response) {

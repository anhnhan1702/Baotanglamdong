...
var vm = new Vue({
    ...
    data: {
        ...
        dataForm: form({
            ...
            .messages({
                'name.required': 'Thâm niên vượt khung bắt buộc nhập',
            }),
        statusForm: '',
        rowId: '',
    ...
    methods: {
        ...
        doAlertDelete(data, row, tr, target) {
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.isConfirmed) {
                    const self = this;
                    axios.delete("/delete-tham-nien-vuot-khung?id=" + data.id)
        ...
        submitform() {
            ...
            if (this.statusForm == "insert") {
                axios.post("/save-tham-nien-vuot-khung", self.dataForm.data).then(function(response) {
                ...
                axios.post("/update-tham-nien-vuot-khung", {
                        id: self.rowId,

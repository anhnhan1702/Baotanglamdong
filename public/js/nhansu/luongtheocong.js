    ...
    methods: {
        ...
        doAlertDelete(data, row, tr, target) {
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.isConfirmed) {
                    const self = this;
                    axios.delete("/delete-luong-theo-cong?id=" + data.id)
        ...
        submitform() {
            ...
            if (this.statusForm == "insert") {
                axios.post("/save-luong-theo-cong", self.dataForm.data).then(function(response) {
                ...
                axios.post("/update-luong-theo-cong", {
                        id: self.rowId,

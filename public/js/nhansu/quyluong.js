...
var vm = new Vue({
    ...
    data: {
        ...
        dataForm: form({
            ...
            .rules({
                name: 'required',
                congtytra: 'required',
                nguoilaodongtra: 'required',

            })
            .messages({
                'name.required': 'Quỹ lương',
                'congtytra.required': 'CSDLĐ bắt buộc nhập',
                'nguoilaodongtra.required': 'NLĐ bắt buộc nhập',
    ...
    methods: {
        ...
        doAlertEdit(data) {
            ...
            this.dataForm.data.congtytra = data.congtytra;
            this.dataForm.data.nguoilaodongtra = data.nguoilaodongtra;
        ...
        doAlertDelete(data, row, tr, target) {
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.isConfirmed) {
                    const self = this;
                    axios.delete("/delete-quy-luong?id=" + data.id)
        ...
        submitform() {
            ...
            if (this.statusForm == "insert") {
                axios.post("/save-quy-luong", self.dataForm.data).then(function(response) {

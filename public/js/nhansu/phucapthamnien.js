...
var vm = new Vue({
    ...
    data: {
        ...
        dataForm: form({
            ...
            .messages({
                'name.required': 'Phụ cấp thâm niên bắt buộc nhập',
            }),
        statusForm: '',
        rowId: '',
    ...
    methods: {
        ...
        doAlertDelete(data, row, tr, target) {
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.isConfirmed) {
                    const self = this;
                    axios.delete("/delete-phu-cap-tham-nien?id=" + data.id)
        ...
        submitform() {
            ...
            if (this.statusForm == "insert") {
                axios.post("/save-phu-cap-tham-nien", self.dataForm.data).then(function(response) {
                ...
                axios.post("/update-phu-cap-tham-nien", {
                        id: self.rowId,

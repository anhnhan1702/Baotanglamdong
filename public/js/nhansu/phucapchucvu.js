...
var vm = new Vue({
    ...
    data: {
        ...
        dataForm: form({
            ...
            .messages({
                'name.required': 'Phụ cấp chức vụ bắt buộc nhập',
            }),
        statusForm: '',
        rowId: '',
    ...
    methods: {
        ...
        doAlertDelete(data, row, tr, target) {
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.isConfirmed) {
                    const self = this;
                    axios.delete("/delete-phu-cap-chuc-vu?id=" + data.id)
        ...
        submitform() {
            ...
            if (this.statusForm == "insert") {
                axios.post("/save-phu-cap-chuc-vu", self.dataForm.data).then(function(response) {
                ...
                axios.post("/update-phu-cap-chuc-vu", {
                        id: self.rowId,

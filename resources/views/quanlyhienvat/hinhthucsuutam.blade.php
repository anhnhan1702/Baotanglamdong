...
<div id="demo" class="py-6  h-full ">
    ...
    <div class="mx-auto max-w-8xl  flex">
        ...
        <h1 class="text-base sm:text-xl mt-1 text-gray-900 dark:text-light">&nbsp; Quản lý danh mục/ Hình thức sưu
            tầm</h1>
    </div>
    ...
    methods: {
        ...
        submitform() {
            ...
            if (this.statusForm == "insert") {
                axios.post("/save-hinh-thuc-suu-tam ", self.dataForm.data).then(function(response) {
                ...
                axios.post("/update-hinh-thuc-suu-tam   ", {
                        id: self.rowId,
        ...
        doAlertDelete(data, row, tr, target) {
            ...
            this.$confirm('Thao tác này không thể quay lại, bạn chắc chắn tiếp tục?', 'Cảnh báo', {
                ...
                axios.delete("/delete-hinh-thuc-suu-tam?id=" + data.id)
                    .then(function(response) {
                        self.loadData();
                    })

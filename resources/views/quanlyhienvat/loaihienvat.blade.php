...
<div id="demo" class="py-6  h-full ">
    ...
    <div class="mx-auto max-w-8xl  flex">
        ...
        <h1 class="text-base sm:text-xl  text-gray-900 mt-1 dark:text-light">&nbsp; Quản lý danh mục/ Quản lý loại hiện
            vật</h1>
    </div>
...
var vm = new Vue({
    ...
    methods: {
        ...
        saveform() {
            this.tieude = 'Thêm mới loại hiện vật'
        ...
        submitform() {
            ...
            if (this.statusForm == "insert") {
                axios.post("/save-loai-hien-vat", self.dataForm.data).then(function(response) {
                ...
                axios.post("/update-loai-hien-vat", {
                        id: self.rowId,
        ...
        doAlertDelete(data, row, tr, target) {
            ...
            this.$confirm('Thao tác này không thể quay lại, bạn chắc chắn tiếp tục?', 'Cảnh báo', {
                ...
                axios.delete("/delete-loai-hien-vat?id=" + data.id)
                    .then(function(response) {
                        self.loadData();
                    })

        ...
        methods: {
            ...
            submitform() {
                ...
                if (this.statusForm == "insert") {
                    axios.post("/save-nien-dai-tuong-doi", self.dataForm.data).then(function(response) {
                    ...
                    axios.post("/update-nien-dai-tuong-doi", {
                            id: self.rowId,
            ...
            doAlertDelete(data, row, tr, target) {
                ...
                this.$confirm('Thao tác này không thể quay lại, bạn chắc chắn tiếp tục?', 'Cảnh báo', {
                    ...
                    axios.delete("/delete-nien-dai-tuong-doi?id=" + data.id)
                        .then(function(response) {
                            self.loadData();
                        })

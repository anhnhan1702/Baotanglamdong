...
@section('subcontent')
    <div id="demo" class="py-6  h-full ">
            ...
            <div class="w-6/12   relative mx-auto my-auto rounded-xl shadow-lg  bg-white overflow-auto ">
                <div class="px-8 py-4 w-full grid grid-cols-12 " style="min-width: 600px;">
                    ...
                    <div class="col-span-12  bg-white px-4 py-5 sm:p-4   ">
                        ...
                        <div>
                            <treeselect v-model="ajaxkho" value-consists-of="ALL" :multiple="true"
                                :options="datakho" placeholder="Chọn kho" :normalizer="normalizer" />
                        </div>
                    </div>

                    <el-transfer filterable :filter-method="filterMethod" filter-placeholder="Tên hiện vật"
                        class="col-span-12 flex justify-center items-center py-2"
                        :props="{ key: 'id', label: 'name', initial: 'name' }" v-model="hienvat_id" :data="hienvat">
                    </el-transfer>
        ...
        <div class="mx-auto max-w-8xl  flex">
            <h1 class="text-base sm:text-2xl font-semibold text-gray-900">Quản lý hiện vật / Quản lý phiếu bảo quản</h1>
        </div>
                                        ...
                                        <template>
                                            ...
                                            <el-table-column align="center" width="300">
                                                ...
                                                <template slot-scope="scope">
                                                    ...
                                                    <el-tooltip v-if="scope.row.trangthai == 1" class="item"
                                                        effect="dark" content="Trả hiện vật" placement="top-start">
    ...
    <script>
        var vm = new Vue({
            ...
            watch: {
                ...
                ajaxkho() {
                    const self = this;
                    axios.post("/hien-vat-trong-kho", self.ajaxkho).then(function(response) {
            ...
            methods: {
                ...
                openmodalhienvat(data) {
                    if (data.hienvat_id) {
                        this.hienvat_id = data.hienvat_id;
                    } else {
                        this.hienvat_id = [];
                    }
                    this.ajaxkho = data.kho_id;
                ...
                submitformHienvat() {
                    ...
                    axios.post("/update-phieu", {
                            id: self.rowId,
                            hienvat_id: self.hienvat_id,
                            ajaxkho: self.ajaxkho,
                ...
                submitform() {
                    ...
                    if (this.statusForm == "insert") {
                        axios.post("/save-phieu-bao-quan", self.dataForm.data).then(function(response) {
                        ...
                        axios.post("/update-phieu-bao-quan", {
                                id: self.rowId,
                ...
                doAlertDelete(data, row, tr, target) {
                    ...
                    this.$confirm('Thao tác này không thể quay lại, bạn chắc chắn tiếp tục?', 'Cảnh báo', {
                        ...
                        axios.delete("/delete-phieu-bao-quan?id=" + data.id)
                            .then(function(response) {
                                self.loadData();
                            })

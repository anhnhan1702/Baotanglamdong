...
@section('subhead')
    <title>Quản lý hiện vật trưng bày ảo</title>
@endsection
@section('subcontent')
    <div id="demo" class="py-6  h-full ">
                ...
                <div class=" w-full  overflow-auto ">
                    ...
                    <div class="grid grid-cols-12 ">
                        <div class="col-span-12">
                            <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tên đợt trưng bày ảo:</label>
                        ...
                        <div class="col-span-12">
                            <label for="link" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Đường dẫn:</label>
                        ...
                        <div class="col-span-12">
                            <label for="thoigianbatdau" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Thời gian bắt đầu:</label>
                            <input v-model="dataForm.thoigianbatdau" type="date" name="thoigianbatdau" id="thoigianbatdau"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                placeholder="" required="">

                        </div>
                        <div class="col-span-12">
                            <label for="thoigianketthuc" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Thời gian kết thúc:</label>
                            <input v-model="dataForm.thoigianketthuc" type="date" name="thoigianketthuc" id="thoigianketthuc"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                placeholder="" required="">
        ...
        <div class="mx-auto max-w-8xl flex">
            ...
            <h1 class="text-base sm:text-xl mt-1 text-gray-900 dark:text-light">&nbsp; Quản lý đợt trưng bày ảo
            </h1>
        </div>
                                    ...
                                    <div class="py-4">
                                        ...
                                        <datatable :datatb="datatb" namePaging="pagination" @pagination="pagination">
                                            <template>
                                                ...
                                                <el-table-column prop="name" label="Tên đợt trưng bày ảo ">
                                                    <template slot-scope="scope">
                                                        <a>@{{ scope.row.name }}</a>
                                                    </template>
                                                </el-table-column>
        ...
        var vm = new Vue({
            ...
            data: {
                datatb: {
                    ...
                    // đường dẫn đến ajax
                    url: '/ajax-quan-ly-dot-trung-bay-ao',
            ...
            methods: {
                ...
                saveform() {
                    this.tieude = 'Thêm mới đợt trưng bày ảo'
                    this.dataForm.data.name = '';
                    this.dataForm.data.link = '';
                    this.dataForm.data.thoigianbatdau = '';
                    this.dataForm.data.thoigianketthuc = '';
                ...
                submitform() {
                    ...
                    if (this.statusForm == "insert") {
                        axios.post("/save-quan-ly-dot-trung-bay-ao", self.dataForm.data).then(function(response) {
                        ...
                        axios.post("/update-quan-ly-dot-trung-bay-ao", {
                                id: self.rowId,
                ...
                doAlertEdit(data) {
                    ...
                    this.dataForm.data.thoigianbatdau = data.thoigianbatdau;
                    this.dataForm.data.thoigianketthuc = data.thoigianketthuc;
                    // Sửa tình trạng form
                ...
                doAlertDelete(data, row, tr, target) {
                    ...
                    this.$confirm('Thao tác này không thể quay lại, bạn chắc chắn tiếp tục?', 'Cảnh báo', {
                        ...
                        axios.delete("/delete-quan-ly-dot-trung-bay-ao?id=" + data.id)
                            .then(function(response) {
                                self.loadData();
                                self.$message({
                                    type: 'success',
                ...
                doAlertRedirect(data) {
                    const self = this;
                    window.location.href = "/danh-sach-hien-vat-so-bao-quan?id=" + data.id;
                },

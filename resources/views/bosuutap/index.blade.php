...
<div id="demo" class="py-6  h-full ">
            ...
            <div class="px-8 py-4 w-full grid grid-cols-12 " style="min-width: 600px;">
                ...
                <div class="col-span-12 grid grid-cols-12 py-2">
                    ...
                    <div class=" col-span-12  bg-white py-4 ">
                        ...
                        <input v-model="dataForm.description" name="description" type="text" required
                            class="block w-full appearance-none rounded-md border border-gray-300 px-3 py-2 placeholder-gray-400 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm">
        ...
        <div class="w-6/12   relative mx-auto my-auto rounded-xl shadow-lg  bg-white overflow-auto ">
            <div class="px-8 py-4 w-full grid grid-cols-12 " style="min-width: 600px;">
                ...
                <el-transfer filterable :filter-method="filterMethod" filter-placeholder="State Abbreviations"
                    class="col-span-12 flex justify-center items-center  py-2" :props="{key:'id',label:'name',initial:'name'}"
                    v-model="dataForm.hienvat_id" :data="hienvat">
    ...
    <div class="mx-auto max-w-8xl  flex">
        <h1 class="text-base sm:text-2xl font-semibold text-gray-900 dark:text-light">Quản lý bộ sưu tập </h1>
    </div>
                            ...
                            <div class="row">
                                ...
                                <datatable :datatb="datatb" namePaging="pagination" @pagination="pagination">
                                    <template>
                                        ...
                                        <!-- <el-table-column prop="nameparent" label="Thuộc bộ sưu tập">
                                        </el-table-column> -->
                                        <el-table-column prop="description" label="Mô tả">
                                        </el-table-column>
                                        <el-table-column prop="slhienvat" width="100" label="Số lượng hiện vật">
                                        </el-table-column>
...
<script type="module" src="./js/bosuutap/bosuutap.js"></script>
@endsection

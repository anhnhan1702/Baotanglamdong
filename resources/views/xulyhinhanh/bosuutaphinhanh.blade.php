...
@section('subhead')
<title>Bộ sưu tập hình ảnh</title>
@endsection
@section('subcontent')
<style>
    .cell {
...
<div id="demo" class="py-6  h-full ">
    ...
    <div class="mx-auto max-w-8xl flex">
        ...
        <h1 class="text-base sm:text-xl mt-1 text-gray-900 dark:text-light">&nbsp; Xử lí hình ảnh/ Quản lý bộ sưu tập hình ảnh</h1>
    </div>
                                    ...
                                    <template>
                                        ...
                                        <el-table-column align="center" width="270">
                                            ...
                                            <template slot-scope="scope">
                                                ...
                                                <el-tooltip class="item p-1 " effect="dark" content="Thêm hình ảnh" placement="top-start">
                                                    <el-button size="mini" >
                                                     <uploadfile tenbang="bosuutaphinhanh" :id="scope.row.id"></uploadfile>
                                                    </el-button>
                                                </el-tooltip>
                                            </template>
                                        </el-table-column>
    ...
    var vm = new Vue({
        ...
        data: {
            datatb: {
                ...
                // đường dẫn đến ajax
                url: '/ajax-quan-ly-bo-suu-tap-hinh-anh',
        ...
        methods: {
            ...
            submitform() {
                ...
                if (this.statusForm == "insert") {
                    axios.post("/save-quan-ly-bo-suu-tap-hinh-anh", self.dataForm.data).then(function(response) {
                    ...
                    axios.post("/update-quan-ly-bo-suu-tap-hinh-anh", {
                            id: self.rowId,
            ...
            doAlertDelete(data, row, tr, target) {
                ...
                this.$confirm('Thao tác này không thể quay lại, bạn chắc chắn tiếp tục?', 'Cảnh báo', {
                    ...
                    axios.delete("/delete-quan-ly-bo-suu-tap-hinh-anh?id=" + data.id)
                        .then(function(response) {
                            self.loadData();
                        })

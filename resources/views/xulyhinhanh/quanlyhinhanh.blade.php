...
<div id="demo" class="py-6  h-full ">
    ...
    <div class="mx-auto max-w-8xl  flex">
        <h1 class="text-base sm:text-2xl font-semibold text-gray-900">Xử lý hình ảnh/ Quản lý hình ảnh</h1>
    </div>
                                    ...
                                    <template>
                                        ...
                                        <el-table-column align="center" width="270">
                                            ...
                                            <template slot-scope="scope">
                                                ...
                                                <el-tooltip class="item p-1 " effect="dark" content="Thêm hình ảnh"
                                                    placement="top-start">
                                                    <el-button size="mini">

                                                        <uploadfile tenbang="quanlyhinhanh" :id="scope.row.id">
                                                        </uploadfile>
    ...
    methods: {
        ...
        submitform() {
            ...
            if (this.statusForm == "insert") {
                axios.post("/save-quan-ly-hinh-anh", self.dataForm.data).then(function(response) {
                ...
                axios.post("/update-quan-ly-hinh-anh", {
                        id: self.rowId,
        ...
        doAlertDelete(data, row, tr, target) {
            ...
            this.$confirm('Thao tác này không thể quay lại, bạn chắc chắn tiếp tục?', 'Cảnh báo', {
                ...
                axios.delete("/delete-quan-ly-hinh-anh?id=" + data.id)
                    .then(function(response) {
                        self.loadData();
                    })

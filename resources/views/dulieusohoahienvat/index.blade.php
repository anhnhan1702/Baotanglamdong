...
@section('subhead')
    <title>Quản lý số hóa dữ liệu hiện vật</title>
@endsection
@section('subcontent')
    <div id="demo" class="py-6  h-full ">
                ...
                <div class="px-8 py-4 w-full grid grid-cols-12 " style="min-width: 600px;">
                    ...
                    <div class="col-span-12 grid grid-cols-12 py-2">
                        <div class=" col-span-12  bg-white py-4 ">
                            <label class="block text-sm font-medium text-gray-700">Tên hiện vật số hóa</label>
                        ...
                        <div class="sm:col-span-6 col-span-12  bg-white px-4 py-5 sm:p-4">
                            ...
                            <uploadfile2 class="" tenbang="sohodulieuhienvat" :id="dataForm.uuid">
                            </uploadfile2>
                        </div>
                    </div>
                    <!--footer-->
        ...
        <div class="mx-auto max-w-8xl  flex">
            <h1 class="text-base sm:text-2xl font-semibold text-gray-900 dark:text-light">Quản lý số hóa dữ liệu hiện vật </h1>
        </div>
                                ...
                                <div class="row">
                                    ...
                                    <datatable :datatb="datatb" namePaging="pagination" @pagination="pagination">
                                        <template>
                                            ...
                                            <el-table-column prop="name" label="Tên hiện vật số hóa">
                                            </el-table-column>
    ...
    <script type="module" src="./js/sohoadulieuhienvat/sohoadulieuhienvat.js"></script>
@endsection

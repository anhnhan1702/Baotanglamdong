...
@section('subcontent')
    <div id="demo" class="py-6  h-full ">
        ...
        <div class="mx-auto max-w-8xl flex">
            ...
            <h1 class="text-base sm:text-xl mt-1 text-gray-900 dark:text-light">&nbsp; Sổ Bảo Quản Hiện Vật, Cần Bảo Quản
            </h1>
        </div>
                                                ...
                                                <el-table-column align="center" width="270">
                                                    ...
                                                    <template slot-scope="scope">
                                                        ...
                                                        <el-tooltip class="item" effect="dark"
                                                            content="Danh sách hiện vật" placement="top-start">
    ...
    <script>
        var vm = new Vue({
            ...
            methods: {
                ...
                saveform() {
                    this.tieude = 'Thêm mới hiện vật bảo quản, cần bảo quản'
                ...
                submitform() {
                    ...
                    if (this.statusForm == "insert") {
                        axios.post("/save-so-bao-quan-hien-vat", self.dataForm.data).then(function(response) {
                        ...
                        axios.post("/update-so-bao-quan-hien-vat", {
                                id: self.rowId,
                ...
                doAlertEdit(data) {
                    ...
                    this.tieude = 'Sửa thông tin  hiện vật bảo quản, cần bảo quảnt'
                ...
                doAlertDelete(data, row, tr, target) {
                    ...
                    this.$confirm('Thao tác này không thể quay lại, bạn chắc chắn tiếp tục?', 'Cảnh báo', {
                        ...
                        axios.delete("/delete-so-bao-quan-hien-vat?id=" + data.id)
                            .then(function(response) {
                                self.loadData();
                                self.$message({
                                    type: 'success',

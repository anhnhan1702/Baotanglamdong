...
@section('subhead')
<title>Danh sách hiện vật </title>
<style>
...
@endsection
@section('subcontent')
<div id="demo" class="  h-full">
    <!--  -->
    <!-- --------------------danh sách hiện vật------------------------ -->
    <div v-cloak v-bind:class="{ hidden: isActivemodal_3 }" style="z-index: 100" class="min-w-screen h-screen animated fadeIn faster 
        ...
        <div @click="closemodal_3()" class="absolute bg-black opacity-80 inset-0 z-0"></div>
        ...
        <div class=" sm:h-11/12 h-4/5 p-5 relative mx-auto my-auto rounded-xl shadow-lg  bg-white overflow-y-auto">
            ...
            <div id="hiddenScroll" class="px-4 py-6 w-full grid grid-cols-12 overflow-y-auto ">
                <div id="printMe2" class=" col-span-12 grid grid-cols-12">
                    ...
                    <div class="sm:col-span-12 col-span-12 ">
                        ...
                        <table class="w-full">
                            ...
                            <tr v-for="(item, index) in danhsachhienvat">
                                ...
                                <td class="border border-black w-16"> <img class="p-1 w-full" :src='item.anh' alt=""></td>
                    ...
                    <div class="col-span-12 text-base text-right">
                        <i> Lâm Đồng, ngày <span class="px-2 w-1"></span> tháng<span class="px-2 w-1"></span> năm <span class="px-4 w-1"></span></i>
                    </div>
            ...
            <button
                ...
                <button class="items-center px-4 py-2 border border-blue-700   text-sm font-medium rounded-md shadow-sm text-blue-700 bg-white hover:text-white hover:bg-blue-700" @click="print2">In phiếu</button>
                <button @click="closemodal_3()" class=" items-center px-4 py-2 border border-red-700   text-sm font-medium rounded-md shadow-sm text-red-700 bg-white hover:text-white hover:bg-red-700 ">Thoát</button>
            </div>
    ...
    <!--  -->
    <div v-cloak v-bind:class="{ hidden: isActivemodal_1 }" style="z-index: 100" class="min-w-screen h-screen animated fadeIn faster 
         fixed  left-0 top-0 flex justify-center items-center inset-0 outline-none focus:outline-none bg-no-repeat bg-center bg-cover">
        ...
        <div class="sm:h-11/12 h-4/5 p-5 relative mx-auto my-auto rounded-xl shadow-lg  bg-white">
            <div id="hiddenScroll" class="px-4 py-6 w-full grid grid-cols-12 overflow-y-auto " style="height:90%">
                <div id="printMe" class=" col-span-12 grid grid-cols-12">
                    ...
                    <div class="sm:col-span-12 col-span-12 ">
                        ...
                        <table class="w-full border-collapse border border-black">
                            <tr>
                                ...
                                <td class="border border border-black text-center w-40 p-1" rowspan="3" style="width: 35%;">
                                    <qr-code :text="'http://quanly.baotanglamdong.com.vn/thong-tin-hien-vat/'+tableDataView.id" :value="tableDataView.id" class="flex justify-center p-2" size="100">
                    ...
                    <div class="col-span-12 text-base py-2 text-right">
                        <i>
                            Lâm Đồng, ngày<span class="px-2 w-1"></span> tháng<span class="px-2 w-1"></span> năm <span class="px-4 w-1"></span>
                        </i>
                    </div>
                    <div class="col-span-12 flex justify-around text-sm">
                        <div class="text-center">
            ...
            <!--footer-->
            <div class="col-span-12 text-center  md:block flex p-2 justify-center">
                <button class="items-center px-4 py-2 border border-green-700   text-sm font-medium rounded-md shadow-sm text-green-700 bg-white hover:text-white hover:bg-green-700" @click="exportword(tableDataView)">Xuất word</button>
                <button class="items-center px-4 py-2 border border-blue-700   text-sm font-medium rounded-md shadow-sm text-blue-700 bg-white hover:text-white hover:bg-blue-700" @click="print">Print</button>
                <button @click="closemodal_1()" class=" items-center px-4 py-2 border border-red-700   text-sm font-medium rounded-md shadow-sm text-red-700 bg-white hover:text-white hover:bg-red-700 ">Thoát</button>
            </div>

        </div>

    </div>
    <div v-cloak v-bind:class="{ hidden: isActivemodal_2 }" style="z-index: 100" class="min-w-screen h-screen animated fadeIn faster 
         fixed  left-0 top-0 flex justify-center items-center inset-0 outline-none focus:outline-none bg-no-repeat bg-center bg-cover">
    ...
    <div class="px-4 sm:px-4 md:px-4 grid grid-cols-10">
        ...
        <div class=" col-span-10 grid grid-cols-12">
            <div class="col-span-12 xl:col-span-3 sm:col-span-4 sm:pr-4 mt-1">
                <select v-model="hinhthucsuutam" class="rounded-md w-full border border-gray-400 p-2 form-control form-select">
            ...
            <div class="col-span-12 xl:col-span-3 sm:col-span-6 sm:pr-4 mt-1">
                <select v-model="chatlieu" class="rounded-md w-full border border-gray-400 p-2 form-control form-select ">
            ...
            <div class="col-span-12 xl:col-span-3 sm:col-span-4 sm:pr-4 mt-1">
                <select v-model="loaihienvat" class="rounded-md w-full border border-gray-400 p-2 form-control form-select ">
            ...
            <div class="col-span-12 xl:col-span-3 sm:col-span-4 sm:pr-4 mt-1">
                <treeselect v-model="vitrihienvat" required value-consists-of="LEAF_PRIORITY" :multiple="false" :options="datakho" placeholder="Chọn kho" :normalizer="normalizer" />
            </div>
            <!-- <div class="col-span-12 xl:col-span-3 sm:col-span-4 sm:pr-4 mt-1">
        ...
        <div class="relative col-span-10 md:col-span-5 mt-2">
            <div class="flex absolute inset-y-0 left-0 items-center pl-3 pointer-events-none">
                <svg class="w-5 h-5 text-gray-500 dark:text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" d="M8 4a4 4 0 100 8 4 4 0 000-8zM2 8a6 6 0 1110.89 3.476l4.817 4.817a1 1 0 01-1.414 1.414l-4.816-4.816A6 6 0 012 8z" clip-rule="evenodd"></path>
                </svg>
            </div>
            <input type="text" v-model="search" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Nhập hiện vật, số ký hiệu" required>

        </div>
        <button type="submit" @click="searchinfohienvat" class="mt-2 col-span-10 md:col-span-2 inline-flex items-center py-2 px-3 ml-2 text-sm font-medium text-white bg-blue-700 rounded-lg border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"><svg class="mr-2 -ml-1 w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path>
            </svg>TÌM KIẾM
        </button>
        <button @click="openmodalDshienvat()" type="button" class="mt-2  col-span-10  sm:col-span-3 py-2 px-3 ml-2 text-sm  text-sm font-medium text-white bg-blue-700 rounded-lg border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
        ...
        <div class="py-4 datatable">
            <div class=" rounded-lg border-4 border-dashed border-gray-200 bg-white " style="min-height:80vh ;">
                <div class="max-w-8xl mx-auto px-4 sm:px-6 md:px-8 mt-6">
                    <h1 class="text-center font-bold text-2xl text-indigo-500 uppercase py-2">Danh sách hiện vật thuộc
                        {{$name}}
                    </h1>
                    <template>
                                    ...
                                    <template>
                                        <el-table-column align="center" width="170">
                                            ...
                                            <template slot-scope="scope">
                                                ...
                                                <el-tooltip class="item" effect="dark" content="Xem file" placement="top-start">
                                        ...
                                        <el-table-column  sortable prop="name" width="150" label="Tên">
                                        </el-table-column>
                                        <el-table-column sortable prop="so_ky_hieu" width="150" label="Số ký hiệu">
                                        </el-table-column>
                                        <el-table-column sortable prop="ten_khac" width="150" label="Tên khác">
                                        </el-table-column>
                                        <el-table-column  sortable prop="chu_nhan" width="200" label="Chủ nhân hiện vật">
                                            <template slot-scope="scope">
                                                <p v-html="scope.row.chu_nhan"></p>
                                            </template>
                                        </el-table-column>
                                        <el-table-column  sortable prop="dia_diem_st" width="200" label="Địa điểm sưu tầm">
                                        </el-table-column>
                                        <el-table-column sortable prop="hinhthucsuutam" width="200" label="Hình thức sưu tầm">
                                        </el-table-column>
                                        <el-table-column sortable prop="thoi_gian_st" width="160" label="Thời gian sưu tầm">
                                        </el-table-column>
                                        <el-table-column sortable prop="tinh_trang_hv" width="160" label="Tình trạng hiện vật">
                                        </el-table-column>
                                        <el-table-column sortable prop="tenloaihienvat" width="150" label="Loại hiện vật">
                                        </el-table-column>
                                        <el-table-column sortable prop="chatlieu" width="150" label="Chất liệu">
                                        </el-table-column>

                                        <el-table-column sortable prop="dudoan_niendai" width="150" label="Dự đoán niên đại">
                                        </el-table-column>
                                        <el-table-column prop="baoquan_phucche" width="100" label="Bảo quản, phục chế">
                                        </el-table-column>
                                        ...
                                        <el-table-column label="Trạng thái" width="150" align="center">
                                            <template slot-scope="scope">
                                                <span class="inline-flex rounded-full bg-red-500 px-2 text-xs font-semibold leading-5 text-white" v-if="!scope.row.checkxuatnhap"> Chưa nhập kho</span>
                                                <span class="inline-flex rounded-full bg-green-500 px-2 text-xs font-semibold leading-5 text-white" v-else-if="scope.row.checkxuatnhap == 1"> Đã nhập kho</span>
                                                <span class="inline-flex rounded-full bg-gray-500 px-2 text-xs font-semibold leading-5 text-white" v-else-if="scope.row.checkxuatnhap == 2"> Đã xuất kho</span>
                                                <span class="inline-flex rounded-full bg-yellow-500 px-2 text-xs font-semibold leading-5 text-white" v-else-if="scope.row.checkxuatnhap == 3"> Bảo dưỡng</span>
                                                <span class="inline-flex rounded-full bg-blue-500 px-2 text-xs font-semibold leading-5 text-white" v-else>Trưng bày </span>
                                            </template>
                                        </el-table-column>
...
<script type="module" src="./js/galleryhienvat/galleryhienvat.js"></script>
@endsection
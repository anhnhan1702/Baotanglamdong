...
<div class="border-b border-theme-29 -mt-10 md:-mt-5 -mx-3 sm:-mx-8 px-3 sm:px-8 pt-3 md:pt-0 mb-10">
    <div class="top-bar-boxed flex items-center">
        ...
        {{-- </div>--}}
        {{-- <div class="ml-3">{{ $faker['users'][0]['name'] }}
    </div>--}}
    {{-- <div class="ml-auto w-48 truncate text-gray-600 text-xs text-right">{{ $faker['users'][0]['email'] }}
</div>--}}
{{-- </a>--}}
{{-- @endforeach--}}
{{-- </div>--}}
            ...
            <div class="cursor-pointer relative flex items-center {{ $key ? 'mt-5' : '' }}">
                ...
                <div class="ml-2 overflow-hidden">
                    <div class="flex items-center">
                        <a href="javascript:;" class="font-medium truncate mr-5">123</a>
        ...
        <div class="dropdown-menu__content box bg-theme-26 dark:bg-dark-6 text-white">
            <div class="p-4 border-b border-theme-27 dark:border-dark-3">
                <div class="font-medium"><?php
                    ...
                    if(auth()->user()->donvi_ma != 0)
                    {
                        $tendv = Donvi::where('ma',auth()->user()->donvi_ma )->first();
                        echo $tendv->name;
                    }
                    else
                    {
...
<div class="grid grid-cols-12">
    <div class="col-span-2 sm:block hidden">
        <!-- BEGIN: Top Menu -->
        <nav class="top-nav py-10">
            <ul>

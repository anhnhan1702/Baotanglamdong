...
@section('subcontent')
    <div id="demo" class="py-6  h-full ">
        ...
        <div v-cloak v-bind:class="{ hidden: isActivemodal }" style="z-index: 100"
         ...
         fixed  left-0 top-0 flex justify-center items-center inset-0 outline-none focus:outline-none bg-no-repeat bg-center bg-cover">
            ...
            <div class="w-6/12   relative mx-auto my-auto rounded-xl shadow-lg  bg-white overflow-auto ">
                <div class="px-8 py-4 w-full grid grid-cols-12 " style="min-width: 600px; max-height: calc(100vh - 50px)">
                    ...
                    <div class="col-span-12 grid grid-cols-12 py-2">
                        {{-- <div class=" col-span-12  bg-white py-4 ">
                            ...
                            <input @change="handleFileChange" name="title" type="file"
                        ...
                        <div class=" col-span-12  bg-white py-4 ">
                            ...
                            <label for="fileInput" class="flex gap-4 items-center">
                                <div class="w-28 text-center py-2 rounded-lg bg-blue-600 text-white font-medium">Chọn ảnh</div>
                                @{{ namefile }}
                        ...
                        <div class=" col-span-12  bg-white py-4 ">
                            ...
                            <input v-model="dataForm.keyword" name="keyword" type="text" 
                                class="block w-full appearance-none rounded-md border border-gray-300 px-3 py-2 placeholder-gray-400 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm">
                        </div>
                    </div>
                    <!--footer-->
        ...
        <div class="mx-auto max-w-8xl  flex">
            <h1 class="text-base sm:text-2xl font-semibold text-gray-900 dark:text-light">Quản lý trang con </h1>
        </div>
                                ...
                                <div class="row">
                                    ...
                                    <datatable :datatb="datatb" namePaging="pagination" @pagination="pagination">
                                        <template>
                                            ...
                                            <!-- <el-table-column prop="nameparent" label="Thuộc trang con">
                                            </el-table-column> -->
    ...
    <script type="module" src="./js/post/pagenew.js"></script>
@endsection

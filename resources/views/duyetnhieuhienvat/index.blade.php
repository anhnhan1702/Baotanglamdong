...
<div v-cloak v-bind:class="{ hidden: isActivemodal_1 }" style="z-index: 100"
    ...
    <div v-cloak v-bind:class="{ hidden: isActivemodal_2 }" style="z-index: 100"
        ...
        <div class="sm:h-11/12 h-4/5 p-5 w-6/12  relative mx-auto my-auto rounded-xl shadow-lg  bg-white">
            <div id="hiddenScroll" class="px-4 py-6 w-full grid grid-cols-12 overflow-y-auto " style="height:90%">
                <div class="col-span-12  text-center sm:text-3xl text-base py-2  font-medium">
                    Hình ảnh hiện vật
                </div>
                <div v-for="item in anhhienvat" class="col-span-4 p-2">
                    <a :href="item.link" download="">
                        <img class=" w-full" :src="item.link" alt="">
                    </a>
                ...
                <div v-for="file in tailieuhienvat" class="col-span-4 flex p-4">
                    <div>

                        <div class=" relative w-full  -mt-4 mx-auto">
                            <img class=" w-full"
                                v-if="file.duoifile == 'img' || file.duoifile == 'png'|| file.duoifile == 'jpg'"
                                :src="file.link">
                            <a data-fancybox data-type="iframe" target="_blank" :href="file.linkview"
                                data-small-btn="true" data-iframe='{"preload":false}'>
                                <img class="w-28 ml-12 mx-auto -mt-6"
                                ...
                                <img class="w-28 ml-12 mx-auto -mt-6"
                                    ...
                                    src="/images/doc.png">
                                <img class="w-28 ml-12 mx-auto -mt-6"
                                    v-if="file.duoifile == 'PDF' || file.duoifile == 'pdf'" src="/images/pdf.png">

                            </a>

                            <div class=" text-ellipsis overflow-hidden  -mt-16 w-10/12 text-center mx-auto">
                                @{{file.tenfile}}
                            </div>
                        </div>
    ...
    <div class="px-4 sm:px-4 md:px-4 grid grid-cols-10">
        ...
        <div class=" col-span-10 grid grid-cols-12">
            ...
            <div class="col-span-12 xl:col-span-3 sm:col-span-4 sm:pr-4 mt-1">
                <button type="submit" @click="Duyetnhieuhienvat"
                    class="col-span-5 md:col-span-1 inline-flex items-center p-2 text-sm font-medium text-white bg-blue-700 rounded-lg border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"><svg
                        class=" -ml-1 w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                        xmlns="http://www.w3.org/2000/svg">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path>
                    </svg>Duyệt nhiều hiện vật
                </button>
            </div>
        </div>
        <div class="relative col-span-12 md:col-span-9 mt-2">
        ...
        <button type="submit" @click="searchinfohienvat"
            class="mt-2 col-span-5 md:col-span-1 inline-flex items-center py-2.5 px-3 ml-2 text-sm font-medium text-white bg-blue-700 rounded-lg border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"><svg
                        ...
                        <div id="app" class="col-12">
                            <div class="row">
                                ...
                                <datatable :datatb="datatb" namePaging="pagination" @pagination="pagination"
                                    methodselect="changeselect" @changeselect="changeselect">
                                    <template>
...
<script type="module" src="./js/duyetnhieuhienvat/duyetnhieuhienvat.js"></script>
@endsection
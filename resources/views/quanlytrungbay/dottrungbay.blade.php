...
@section('subhead')
<title>Quản lý đợt trưng bày</title>
@endsection
@section('subcontent')
<div id="demo" class="py-6  h-full ">
    ...
    <div class="mx-auto max-w-8xl  flex">
        <h1 class="text-base sm:text-2xl font-semibold text-gray-900 dark:text-light">Quản lý đợt trưng bày </h1>
    </div>
...
<script type="module" src="./js/quanlytrungbay/dottrungbay.js"></script>
@endsection
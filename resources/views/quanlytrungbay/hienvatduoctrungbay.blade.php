...
@section('subhead')
<title>Quản lý hiện vật được trưng bày</title>
@endsection
@section('subcontent')
<div id="demo" class="py-6  h-full ">
                ...
                <div class="grid grid-cols-12 ">
                    <div
                     class="col-span-12 px-4 py-5 sm:p-4">
                        <label for="name"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tên hiện vật:</label>
    ...
    <div class="mx-auto max-w-8xl  flex">
        <h1 class="text-base sm:text-2xl font-semibold text-gray-900 dark:text-light">Quản lý hiện vật được trưng bày </h1>
    </div>
...
<script type="module" src="./js/quanlytrungbay/hienvatduoctrungbay.js"></script>
@endsection